...
export interface RelayerRegistryBurnableInterface extends Interface {
    getFunction(nameOrSignature: "burn" | "burnAmount" | "ens" | "feeManager" | "getRelayerBalance" | "getRelayerEnsHash" | "governance" | "initialize" | "isRelayer" | "isRelayerRegistered" | "minStakeAmount" | "nullifyBalance" | "register" | "registerPermit" | "registerWorker" | "relayers" | "setMinStakeAmount" | "setTornadoRouter" | "stakeToRelayer" | "stakeToRelayerPermit" | "staking" | "torn" | "tornadoRouter" | "unregisterRelayer" | "unregisterWorker" | "workers"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "burnAmount", values: [BigNumberish]): string;
...
export interface RelayerRegistryBurnable extends BaseContract {
    connect(runner?: ContractRunner | null): RelayerRegistryBurnable;
    waitForDeployment(): Promise<this>;
    interface: RelayerRegistryBurnableInterface;
    ...
    burnAmount: TypedContractMethod<[toBurn: BigNumberish], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "burnAmount"): TypedContractMethod<[toBurn: BigNumberish], [void], "nonpayable">;
