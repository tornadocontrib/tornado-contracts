...
export interface IENSResolver2Interface extends Interface {
...
export interface IENSResolver2 extends BaseContract {
    connect(runner?: ContractRunner | null): IENSResolver2;
    waitForDeployment(): Promise<this>;
    interface: IENSResolver2Interface;
