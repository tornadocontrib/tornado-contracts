...
export interface ApprovalTornadoInterface extends Interface {
...
export interface ApprovalTornado extends BaseContract {
    connect(runner?: ContractRunner | null): ApprovalTornado;
    waitForDeployment(): Promise<this>;
    interface: ApprovalTornadoInterface;
