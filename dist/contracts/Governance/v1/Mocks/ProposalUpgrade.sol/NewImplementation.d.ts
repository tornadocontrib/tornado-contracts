...
export interface NewImplementationInterface extends Interface {
    getFunction(nameOrSignature: "CLOSING_PERIOD" | "EXECUTION_DELAY" | "EXECUTION_EXPIRATION" | "PROPOSAL_THRESHOLD" | "QUORUM_VOTES" | "VOTE_EXTEND_TIME" | "VOTING_DELAY" | "VOTING_PERIOD" | "canWithdrawAfter" | "castDelegatedVote" | "castVote" | "delegate" | "delegatedTo" | "execute" | "getReceipt" | "initialize" | "latestProposalIds" | "lock" | "lockWithApproval" | "lockedBalance" | "newVariable" | "proposalCount" | "proposals" | "propose" | "proposeByDelegate" | "setClosingPeriod" | "setExecutionDelay" | "setExecutionExpiration" | "setProposalThreshold" | "setQuorumVotes" | "setTimestamp" | "setTorn" | "setVoteExtendTime" | "setVotingDelay" | "setVotingPeriod" | "state" | "time" | "torn" | "undelegate" | "unlock"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "Delegated" | "Overriden" | "ProposalCreated" | "ProposalExecuted" | "Undelegated" | "Voted"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "setTorn", values: [AddressLike]): string;
    ...
    decodeFunctionResult(functionFragment: "setTorn", data: BytesLike): Result;
...
export declare namespace OverridenEvent {
    type InputTuple = [x: BigNumberish];
    type OutputTuple = [x: bigint];
    interface OutputObject {
        x: bigint;
    }
    type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export interface NewImplementation extends BaseContract {
    connect(runner?: ContractRunner | null): NewImplementation;
    waitForDeployment(): Promise<this>;
    interface: NewImplementationInterface;
    ...
    newVariable: TypedContractMethod<[], [bigint], "view">;
    ...
    setTorn: TypedContractMethod<[torna: AddressLike], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "newVariable"): TypedContractMethod<[], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "setTimestamp"): TypedContractMethod<[time_: BigNumberish], [void], "nonpayable">;
    getFunction(nameOrSignature: "setTorn"): TypedContractMethod<[torna: AddressLike], [void], "nonpayable">;
    ...
    getEvent(key: "Overriden"): TypedContractEvent<OverridenEvent.InputTuple, OverridenEvent.OutputTuple, OverridenEvent.OutputObject>;
    ...
    filters: {
        ...
        "Overriden(uint256)": TypedContractEvent<OverridenEvent.InputTuple, OverridenEvent.OutputTuple, OverridenEvent.OutputObject>;
        Overriden: TypedContractEvent<OverridenEvent.InputTuple, OverridenEvent.OutputTuple, OverridenEvent.OutputObject>;
