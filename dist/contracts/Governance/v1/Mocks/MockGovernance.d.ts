...
export interface MockGovernanceInterface extends Interface {
    getFunction(nameOrSignature: "CLOSING_PERIOD" | "EXECUTION_DELAY" | "EXECUTION_EXPIRATION" | "PROPOSAL_THRESHOLD" | "QUORUM_VOTES" | "VOTE_EXTEND_TIME" | "VOTING_DELAY" | "VOTING_PERIOD" | "canWithdrawAfter" | "castDelegatedVote" | "castVote" | "delegate" | "delegatedTo" | "execute" | "getReceipt" | "initialize" | "latestProposalIds" | "lock" | "lockWithApproval" | "lockedBalance" | "proposalCount" | "proposals" | "propose" | "proposeByDelegate" | "setClosingPeriod" | "setExecutionDelay" | "setExecutionExpiration" | "setProposalThreshold" | "setQuorumVotes" | "setTimestamp" | "setTorn" | "setVoteExtendTime" | "setVotingDelay" | "setVotingPeriod" | "state" | "time" | "torn" | "undelegate" | "unlock"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "Delegated" | "ProposalCreated" | "ProposalExecuted" | "Undelegated" | "Voted"): EventFragment;
