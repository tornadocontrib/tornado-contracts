...
export interface IUniswapV3PoolStateInterface extends Interface {
    getFunction(nameOrSignature: "feeGrowthGlobal0X128" | "feeGrowthGlobal1X128" | "liquidity" | "observations" | "positions" | "protocolFees" | "slot0" | "tickBitmap" | "ticks"): FunctionFragment;
