...
export interface GovernanceProposalStateUpgradeInterface extends Interface {
...
export interface GovernanceProposalStateUpgrade extends BaseContract {
    connect(runner?: ContractRunner | null): GovernanceProposalStateUpgrade;
    waitForDeployment(): Promise<this>;
    interface: GovernanceProposalStateUpgradeInterface;
