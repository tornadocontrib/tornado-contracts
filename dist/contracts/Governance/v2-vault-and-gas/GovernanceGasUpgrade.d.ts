...
export interface GovernanceGasUpgrade extends BaseContract {
    connect(runner?: ContractRunner | null): GovernanceGasUpgrade;
    waitForDeployment(): Promise<this>;
    interface: GovernanceGasUpgradeInterface;
