...
export declare namespace TornadoV2 {
    type CreateInstanceStruct = {
        token: AddressLike;
        denomination: BigNumberish;
        vault: AddressLike;
    };
    type CreateInstanceStructOutput = [
        token: string,
        denomination: bigint,
        vault: string
    ] & {
...
export interface TornadoV2Interface extends Interface {
    getFunction(nameOrSignature: "COMMITMENT_TYPE" | "COMMITMENT_TYPEHASH" | "FIELD_SIZE" | "REVISION" | "ROOT_HISTORY_SIZE" | "WITNESS_TYPE_STRING" | "ZERO_VALUE" | "commitments" | "createInstance" | "denomination" | "deposit" | "feeRate" | "feeTo" | "filledSubtrees" | "getLastRoot" | "getSignatureType" | "hasInstance" | "hashLeftRight" | "hasher" | "initialize" | "instance" | "instanceIndex" | "isKnownRoot" | "isSpent" | "isSpentArray" | "levels" | "nextIndex" | "nullifierHashes" | "permit2" | "roots" | "token" | "verifier" | "weth" | "withdraw" | "witness" | "zeros"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "createInstance", values: [AddressLike, BigNumberish, AddressLike]): string;
    ...
    encodeFunctionData(functionFragment: "hasInstance", values: [BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "instance", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "instanceIndex", values?: undefined): string;
    encodeFunctionData(functionFragment: "isKnownRoot", values: [BigNumberish, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "witness", values: [TornadoV2.PermitCommitmentsStruct]): string;
    ...
    decodeFunctionResult(functionFragment: "createInstance", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "hasInstance", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "instanceIndex", data: BytesLike): Result;
...
export interface TornadoV2 extends BaseContract {
    ...
    getFunction(nameOrSignature: "createInstance"): TypedContractMethod<[
        _token: AddressLike,
        _denomination: BigNumberish,
        _vault: AddressLike
    ], [
    ...
    getFunction(nameOrSignature: "hasInstance"): TypedContractMethod<[arg0: BytesLike], [boolean], "view">;
    ...
    getFunction(nameOrSignature: "instance"): TypedContractMethod<[
        id: BigNumberish
    ], [
        TornadoV2.InstanceViewStructOutput
    ], "view">;
    getFunction(nameOrSignature: "instanceIndex"): TypedContractMethod<[], [bigint], "view">;
    ...
    filters: {
        "Deposit(uint256,address,bytes32,uint32,uint256)": TypedContractEvent<DepositEvent.InputTuple, DepositEvent.OutputTuple, DepositEvent.OutputObject>;
        Deposit: TypedContractEvent<DepositEvent.InputTuple, DepositEvent.OutputTuple, DepositEvent.OutputObject>;
        "Withdrawal(uint256,address,bytes32,address,uint256,uint256)": TypedContractEvent<WithdrawalEvent.InputTuple, WithdrawalEvent.OutputTuple, WithdrawalEvent.OutputObject>;
