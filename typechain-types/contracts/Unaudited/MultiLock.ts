...
export namespace CallApprovedEvent {
  export type InputTuple = [id: BytesLike, proposer: AddressLike];
  export type OutputTuple = [id: string, proposer: string];
...
export namespace CallDisapprovedEvent {
  export type InputTuple = [id: BytesLike, proposer: AddressLike];
  export type OutputTuple = [id: string, proposer: string];
  export interface OutputObject {
    id: string;
...
export namespace QuorumChangeEvent {
...
export interface MultiLock extends BaseContract {
  ...
  >;
  getFunction(
    nameOrSignature: "queued"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "removeProposer"
  ): TypedContractMethod<[oldProposer: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  getEvent(
    ...
    CallApprovedEvent.InputTuple,
    CallApprovedEvent.OutputTuple,
    CallApprovedEvent.OutputObject
  >;
  getEvent(
    key: "CallDisapproved"
  ): TypedContractEvent<
    CallDisapprovedEvent.InputTuple,
    CallDisapprovedEvent.OutputTuple,
    CallDisapprovedEvent.OutputObject
  >;
  getEvent(
    key: "CallExecuted"
  ): TypedContractEvent<
  ...
  getEvent(
    ...
    QuorumChangeEvent.InputTuple,
    QuorumChangeEvent.OutputTuple,
    QuorumChangeEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    "CallApproved(bytes32,address)": TypedContractEvent<
      CallApprovedEvent.InputTuple,
      CallApprovedEvent.OutputTuple,
      CallApprovedEvent.OutputObject
    >;
    CallApproved: TypedContractEvent<
      CallApprovedEvent.InputTuple,
      CallApprovedEvent.OutputTuple,
      CallApprovedEvent.OutputObject
    >;

    "CallDisapproved(bytes32,address)": TypedContractEvent<
      CallDisapprovedEvent.InputTuple,
      CallDisapprovedEvent.OutputTuple,
      CallDisapprovedEvent.OutputObject
    >;
    CallDisapproved: TypedContractEvent<
      CallDisapprovedEvent.InputTuple,
      CallDisapprovedEvent.OutputTuple,
      CallDisapprovedEvent.OutputObject
    >;
    ...
    "QuorumChange(uint256,uint256)": TypedContractEvent<
      QuorumChangeEvent.InputTuple,
      QuorumChangeEvent.OutputTuple,
      QuorumChangeEvent.OutputObject
    >;
    QuorumChange: TypedContractEvent<
      QuorumChangeEvent.InputTuple,
      QuorumChangeEvent.OutputTuple,
      QuorumChangeEvent.OutputObject
    >;
