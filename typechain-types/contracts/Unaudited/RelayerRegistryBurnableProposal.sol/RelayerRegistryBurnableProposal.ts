...
export interface RelayerRegistryBurnableProposalInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "newRelayerRegistry",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "relayerRegistryProxyAddr",
    values?: undefined
  ): string;
...
export interface RelayerRegistryBurnableProposal extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "newRelayerRegistry"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "relayerRegistryProxyAddr"
  ): TypedContractMethod<[], [string], "view">;
