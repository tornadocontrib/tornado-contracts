...
export namespace EchoEvent {
  export type InputTuple = [who: AddressLike, data: BytesLike];
  export type OutputTuple = [who: string, data: string];
...
export interface Echoer extends BaseContract {
  ...
  getEvent(
    ...
    EchoEvent.InputTuple,
    EchoEvent.OutputTuple,
    EchoEvent.OutputObject
  >;

  filters: {
    "Echo(address,bytes)": TypedContractEvent<
      EchoEvent.InputTuple,
      EchoEvent.OutputTuple,
      EchoEvent.OutputObject
    >;
    Echo: TypedContractEvent<
      EchoEvent.InputTuple,
      EchoEvent.OutputTuple,
      EchoEvent.OutputObject
    >;
