...
export namespace OverridenEvent {
  export type InputTuple = [x: BigNumberish];
  export type OutputTuple = [x: bigint];
  export interface OutputObject {
    x: bigint;
  }
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export interface NewImplementation extends BaseContract {
  ...
  ): TypedContractMethod<[time_: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "setTorn"
  ): TypedContractMethod<[torna: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  getEvent(
    ...
    OverridenEvent.InputTuple,
    OverridenEvent.OutputTuple,
    OverridenEvent.OutputObject
  >;
  getEvent(
    key: "ProposalCreated"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "Overriden(uint256)": TypedContractEvent<
      OverridenEvent.InputTuple,
      OverridenEvent.OutputTuple,
      OverridenEvent.OutputObject
    >;
    Overriden: TypedContractEvent<
      OverridenEvent.InputTuple,
      OverridenEvent.OutputTuple,
      OverridenEvent.OutputObject
    >;
