...
export interface IGasCompensationVaultInterface extends Interface {
  getFunction(
    nameOrSignature: "compensateGas" | "withdrawToGovernance"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "compensateGas",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "withdrawToGovernance",
    values: [BigNumberish]
  ): string;
...
export interface IGasCompensationVault extends BaseContract {
  ...
  compensateGas: TypedContractMethod<
    [recipient: AddressLike, gasAmount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "withdrawToGovernance"
